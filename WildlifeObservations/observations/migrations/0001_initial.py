# Generated by Django 3.2.11 on 2022-01-27 19:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('species', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='observations.taxonomyspecies')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Observed', 'Observed'), ('Specimen', 'Specimen'), ('Lost', 'Lost')], max_length=10, null=True)),
                ('created_on', models.DateTimeField(default=django.utils.timezone.now)),
