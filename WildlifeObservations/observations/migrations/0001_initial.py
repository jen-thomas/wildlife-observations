# Generated by Django 3.2.11 on 2022-02-24 10:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('length_head_abdomen', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('length_head_tegmina', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confidence', models.CharField(blank=True, choices=[('In_progress', 'In progress'), ('Check', 'Check'), ('Confirmed', 'Confirmed'), ('Redo', 'Redo'), ('Yes', 'Yes'), ('Review', 'Review')], max_length=11, null=True)),
